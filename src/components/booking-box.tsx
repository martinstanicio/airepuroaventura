...
export default function InscriptionBox({ trip, className, ...props }: Props) {
  const phone = +process.env.NEXT_PUBLIC_PHONE;
  const link = getWhatsAppLink(
    phone,
    `Hola, quiero reservar mi lugar para la salida turística *${trip.title}*`,
  );
  ...
  return (
    ...
    >
      ...
      <div className="prose max-w-full bg-secondary p-4 text-secondary-foreground">
        <p>
          ¿Ya tomaste la decisión? Podés realizar tu reserva <b>100% online</b>.
        </p>
        <p>
          ¡Asegurá tu lugar ahora para no perderte de esta extraordinaria
          aventura!
        </p>
